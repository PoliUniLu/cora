...
class OptimizationContext_tests(unittest.TestCase):
    ...
    def test_coverage_scores_multi_output(self):
        ...
        context = OptimizationContext(
            data,
            ["INTGOV", "ENGIC"],
            input_labels=["ECOFAIL", "STATEFAIL", "REGID", "ECONET"],
            inc_score1=0.5,
        )
        result_pi_details = context.pi_details()
        res_final_pi_details = [
            v.dropna().to_dict() for k, v in result_pi_details.iterrows()
        ]
        expected_result_pi_details = [
            {
                "PI": "ECOFAIL{1}*ECONET{1}",
                "Cov.r": 0.2,
                "Inc.": 0.5,
                "S1": 0.2,
                "S5": 0.2,
            ...
            {"PI": "STATEFAIL{2}*REGID{1}", "Cov.r": 0.2, "Inc.": 0.5},
            {
        ...
        expected_result_system_details = {
            "Cov.": {"Solution details": 1.0},
            "Inc.": {"Solution details": 0.9},
        }
        self.assertEqual(
            result_system_details.to_dict(), expected_result_system_details
        )
    ...
    def test_coverage_scores_single_output(self):
        ...
        expected_result = [
            {"PI": "B", "Cov.r": 0.67, "Inc.": 1.0, "M1": 0.33},
            {"PI": "c", "Cov.r": 0.67, "Inc.": 1.0, "M2": 0.33},
            {"PI": "#a", "Cov.r": 0.67, "Inc.": 1.0, "M1": 0.33, "M2": 0.33},
        ]
