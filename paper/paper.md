...
of the family of configurational comparative methods (CCMs). Modern CCMs
infer INUS structures from sets of configurational data. CORA
generalizes the capabilities of existing CCMs through its ability to
...
[@delorenzo_schmidt_2018; @pearl_2009; @thiem_et_al_2020].
...
Figure <a href="#fig:logigrams1" data-reference-type="ref" data-reference="fig:logigrams1">3</a> and 
Figure <a href="#fig:logigrams2" data-reference-type="ref" data-reference="fig:logigrams2">4</a> for binary 
